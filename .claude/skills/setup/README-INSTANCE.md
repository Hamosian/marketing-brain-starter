...
|-------|----------------|-------------|
| `marketing-os` | "run the marketing OS", "triage marketing", "plan this campaign" | Top-level router that delegates to sub-agents and closes the operating loop |
| `good-morning` | "good morning", "morning brief", "catch me up" | Daily brief with active tasks, team updates, and action items |
