...
See `systems/examples/_example-active-system.md` (engineering), `_example-analytics-system.md` (BI), and `_example-sales-system.md` (sales) for domain-specific examples.
